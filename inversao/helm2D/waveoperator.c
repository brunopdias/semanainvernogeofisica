...
/*< forward operator for fwi for a single frequency >*/
{
    ...
    sparse_factor(omega, n1, n2, d1, d2, input, npml, pad1, pad2,uts);
...
/*< born forward operator >*/
{
    ...
    for ( iw = 0; iw < nw; iw++ ) {
        ...
        /* free memory */
        sparse_free(uts);
        free(**fin); free(*fin); free(fin);
        free(**fborn); free(*fborn); free(fborn);
    }
}
